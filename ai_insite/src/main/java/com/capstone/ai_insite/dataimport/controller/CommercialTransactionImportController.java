...
@RestController
@RequestMapping("/api/admin/import-jobs/public-data/commercial-transactions")
@ConditionalOnProperty(name = "external.public-data.enabled", havingValue = "true")
public class CommercialTransactionImportController {

    private final CommercialTransactionDataImportService importService;

    public CommercialTransactionImportController(
        CommercialTransactionDataImportService importService
    ) {
