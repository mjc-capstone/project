...
@EnabledIfEnvironmentVariable(named = "RUN_P6_ENRICHED_READINESS", matches = "true")
class P6EnrichedDataReadinessIntegrationTest {
    ...
    @Test
    void buildsAndAuditsTheEnrichedHistoricalDataset() {
        ...
        var dataset = existing
            ...
            .orElseGet(() -> datasetService.build(
                new ModelDatasetBuildCommand(
                    DATASET_VERSION,
                    "2023Q2",
                    "2024Q4",
                    "2025Q2",
